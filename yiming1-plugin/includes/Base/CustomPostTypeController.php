...
require_once plugin_dir_path(dirname(__FILE__)).'\Api\Callbacks\CptCallbacks.php';
...
class CustomPostTypeController extends BaseController {
  ...
  public function store_custom_post_types(){
    $options = get_option('yiming1_plugin_cpt');  # option_name
  ...
  public function set_settings(){
    ...
    $args = [
      [
        'option_group' => 'yiming1_plugin_cpt_settings',
        'option_name' => 'yiming1_plugin_cpt',
  ...
  public function set_sections(){
    $args = [
      [
        'id' => 'yiming1_cpt_index',
        'title' => 'Custom Post Type Manager',
        'callback' => array($this->cpt_callbacks, 'cpt_section_manager'),
        'page' => 'yiming1_plugin_cpt', # refer to the menu slug
      ],
    ];
  ...
  public function set_fields(){
    $args = [
      [
        ...
        'page' => 'yiming1_plugin_cpt', # refer to the menu slug
        'section' => 'yiming1_cpt_index', # section id
        'args' => [
          'option_name' => 'yiming1_plugin_cpt',
          'label_for' => 'post_type',
